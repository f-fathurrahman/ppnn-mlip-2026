...
# Buat surface
surf = ase.build.fcc111("Cu", (4, 4, 5), vacuum=10.0 )
...
ase.build.add_adsorbate(
    surf_with_ads, mol_isolated, 3.5, position=(0,0), mol_index=0)
surf_with_ads.calc = calc
ftraj = "Cu111_N2H4_geoopt.traj"
