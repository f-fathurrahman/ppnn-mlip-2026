...
# Buat surface
surf = ase.build.bcc110("Fe", (3, 4, 5), vacuum=10.0 )
...
surf_with_ads = copy.deepcopy(surf)
ase.build.add_adsorbate(
    surf_with_ads, mol_isolated, 3.0, position=(4,8), mol_index=0)
ftraj = "Fe110_N2H4_geoopt.traj"
